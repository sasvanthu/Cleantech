          ...
          <div className="row align-items-center w-100">
            ...
            <div className="col-lg-6 wow fadeInLeft" data-wow-delay=".2s">
              ...
              <p style={{ fontSize: '14px', color: '#aaa', lineHeight: '1.8', maxWidth: '450px', marginBottom: '15px' }}>
                Manufacturing facilities and factories accumulate heavy grease, metal shavings, and hazardous dust that standard cleaning cannot handle.
              </p>
              <p style={{ fontSize: '14px', color: '#aaa', lineHeight: '1.8', maxWidth: '450px', marginBottom: '30px' }}>
                A clean factory floor not only ensures compliance with safety regulations but also extends the life of your machinery and prevents workplace accidents.
              </p>
            ...
            <div className="col-lg-6 position-relative wow fadeInRight" data-wow-delay=".4s" style={{ height: '600px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {/* Product Image */}
              <img src="/assets/img/service/premium-factory-service.png" alt="FACTORY CLEANING" style={{ position: 'relative', zIndex: 2, maxWidth: '100%', maxHeight: '500px', filter: 'drop-shadow(0 30px 40px rgba(0,0,0,0.8))', borderRadius: '12px' }} />
            </div>
          ...
          <div className="row g-4">
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".1s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Heavy-duty floor degreasing & scrubbing</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".2s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>High-pressure washing for tough stains</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".3s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>High-altitude roof and vent dusting</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".4s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Machine and equipment surface cleaning</h6>
                </div>
            </div>
          </div>
        </div>
