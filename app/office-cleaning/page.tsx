          ...
          <div className="row align-items-center w-100">
            ...
            <div className="col-lg-6 wow fadeInLeft" data-wow-delay=".2s">
              ...
              <p style={{ fontSize: '14px', color: '#aaa', lineHeight: '1.8', maxWidth: '450px', marginBottom: '15px' }}>
                A clean and well-maintained office is the backbone of a productive workforce. We provide comprehensive cleaning services tailored for IT parks, corporate headquarters, and workspaces.
              </p>
              <p style={{ fontSize: '14px', color: '#aaa', lineHeight: '1.8', maxWidth: '450px', marginBottom: '30px' }}>
                We utilize advanced cleaning machinery and eco-friendly solutions to target high-touch areas, carpets, and air vents, significantly reducing employee sick leaves.
              </p>
            ...
            <div className="col-lg-6 position-relative wow fadeInRight" data-wow-delay=".4s" style={{ height: '600px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {/* Product Image */}
              <img src="/assets/img/service/premium-office-service.png" alt="OFFICE CLEANING" style={{ position: 'relative', zIndex: 2, maxWidth: '100%', maxHeight: '500px', filter: 'drop-shadow(0 30px 40px rgba(0,0,0,0.8))', borderRadius: '12px' }} />
            </div>
          ...
          <div className="row g-4">
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".1s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Deep cleaning & dusting of workstations</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".2s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Sanitization of high-touch IT equipment</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".3s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Floor scrubbing, buffing, and polishing</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".4s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Glass partition and window cleaning</h6>
                </div>
            </div>
          </div>
        </div>
