          ...
          <div className="row align-items-center w-100">
            ...
            <div className="col-lg-6 wow fadeInLeft" data-wow-delay=".2s">
              ...
              <p style={{ fontSize: '14px', color: '#aaa', lineHeight: '1.8', maxWidth: '450px', marginBottom: '15px' }}>
                Industrial environments present unique cleaning challenges, including chemical spills, hazardous materials, and extreme grime. Cleantech's specialized team is trained for strict safety protocols.
              </p>
              <p style={{ fontSize: '14px', color: '#aaa', lineHeight: '1.8', maxWidth: '450px', marginBottom: '30px' }}>
                We use industrial-grade vacuums with HEPA filtration, robust ride-on sweepers, and specialized chemicals to maintain the highest safety and hygiene standards.
              </p>
            ...
            <div className="col-lg-6 position-relative wow fadeInRight" data-wow-delay=".4s" style={{ height: '600px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {/* Product Image */}
              <img src="/assets/img/service/premium-industrial-service.png" alt="INDUSTRIAL CLEANING" style={{ position: 'relative', zIndex: 2, maxWidth: '100%', maxHeight: '500px', filter: 'drop-shadow(0 30px 40px rgba(0,0,0,0.8))', borderRadius: '12px' }} />
            </div>
          ...
          <div className="row g-4">
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".1s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Hazardous dust and debris removal</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".2s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Chemical spill cleanup and sanitization</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".3s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Industrial tank and silo cleaning</h6>
                </div>
            </div>
            <div className="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay=".4s">
                <div className="ct-bento-card" style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: "12px", padding: "30px", height: "100%" }}>
                    <h6 style={{ color: '#fff' }}>Epoxy floor restoration and scrubbing</h6>
                </div>
            </div>
          </div>
        </div>
