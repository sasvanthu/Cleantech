                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tp-page-title z-index">
                            <h2 class="breadcrumb-title"><span style="color:#fed10c;">Sales</span></h2>
                        ...
                        <div class="tp-service-widget wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="tp-service-widget-list">
                                <ul>
                                    ...
                                    <li><a href="rental-service">Rental <i class="fas fa-angle-right"></i></a></li>
                                </ul>
                            </div>

                            <div class="tp-service-quote-box mt-4">
                                <h4>Looking to Buy?</h4>
                                <p style="color: #001224; font-weight: 500; margin-bottom: 20px; font-size: 14px;">Contact our sales team for the best quotes on cleaning machinery.</p>
                                <a href="contact" class="theme-btn text-center w-100" style="background:#001224; color:#fff;">Contact Sales</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="tp-service-details wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <ul class="premium-check-list mb-40"> 
                                <li>Demo, delivery & Installation charges are absolutely free.</li>
                            </ul>
