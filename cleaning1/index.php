...
<head>
	...
	<title>Klean Max Pro - Professional Office and Home Cleaning Services in Chennai </title>

	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="Klean Max Pro is one of the reputed Company in Chennai for House Cleaning Services in Chennai and Professional Deep Cleaning Services for Office & Commercial Space.">
	...
	<meta name="author" content="Klean Max Pro">

	<!-- FAVICON -->
	<link rel="shortcut icon" href="images/klean-favicon.png">
...
<div class="body">
	<!-- HEADER -->
	<header>
		<nav class="navbar-inverse navbar-lg navbar-fixed-top" style="background: #000 !important; box-shadow: rgba(0, 0, 0, 0.2) 0px 1px 8px;">
			<div class="container">
				<div class="navbar-header">
					<a href="" class="navbar-brand brand"><img src="images/klean-max-footer-logo2.png" alt="logo"></a>
                </div>
					...
					<div class="row">
						<div class="col-md-10">
							<div class="intro-box">
								...
								<div>
									<h4>1. Book a Deep Cleaning from Klean Max Pro</h4>
...
using most efficient vacuums and shampoos.</li>
	...
	<section class="parallax-content parallax1 text-center" data-stellar-background-ratio="0.4">
        ...
        <div class="row">
		<div class="col-md-8">
			<h4>Over 200+ companies have already experienced the Professional Cleaning Services of Klean Max Pro.</h4>
		</div>
        <div class="row">
        <div class="col-md-4">
			<a href="#" class="btn btn-lg btn-primary">Book a Cleaning <i class="icon-arrow-right"></i></a>
	...
	<div class="about-inline text-center">
		<div class="container">
			...
			<h3>Reasons to love Klean Max Pro</h3>
				...
				<div class="col-md-4">
					<div class="text-center">
						...
						<div class="services-content">
							...
							<p style="text-align:justify">At Klean Max Pro, you'll only find the best professionals. All our cleaners are carefully Selected by us and we'd be happy to have Served you to perfection.</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="text-center">
						...
						<div class="services-content">
							...
							<p style="text-align:justify">Klean Max Pro are continuously reviewed by our customers. Each and every Deep Cleaning Work is being monitored by experts at Klean Max Pro inorder to Give you the Perfect finish.</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="text-center">
						...
						<div class="services-content">
							...
							<p style="text-align:justify">At Klean Max Pro, we go above and beyond to create a more trusted and reliable experience through our highly professional approach.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row center-content">
				<div class="col-md-7">
                 ...
                 <div class="col-md-5">
					<h3>Why choose Klean Max Pro for Your Commercial Cleaning?</h3>
		...
		<div class="overlay"></div>
			<div class="container">
				...
				<div class="col-md-12 tc text-center ">
					<h4>Book Klean Max Pro as your Cleaning Professional!</h4>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="c-info">
						...
						<h5><b>Email</b></h5>
						<p><a href="mailto:info@kleanmaxpro.com">info@kleanmaxpro.com</a></p>
					</div>
				</div>
                ...
                <div class="col-lg-3 col-sm-6">
					<div class="c-info">
						...
						<h5><b>WEBSITE</b></h5>
						<p><a href="http://kleanmax.com" >www.kleanmaxpro.com</a></p>
					</div>
				</div>
			</div>
		</div>
...
<div class="call-me call-me-right"><a href="https://wa.me/+917338882034/?text=Hi%21+KleanMax." class="btn1 btn1-success"><i class="fa fa-whatsapp"></i> </a></div>
	...
	<footer class="footer2" id="footer2">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<a href="" class="footer-logo"><img src="images/klean-max-footer-logo2.png" alt="logo"></a>
					<p style="text-align:justify">Klean Max Pro is one of the reputed Company in Chennai for Professional Deep Cleaning Services for Office and Commercial Space.</p>
	...
	<div class="footer-copy">
		<div class="container">
			&copy; 2023. Klean Max Pro. All rights reserved. Designed by <a href="http://binaryresonance.com/">Binary Tech Resonance</a>
	</div>
</div>
