...
<head>
	...
	<meta name="description" content="Klean Max is one of the reputed Company in Chennai for Professional Deep Cleaning Services for Office and Commercial Space.">
	<meta name="keywords" content="Deep Cleaning Services in Chennai, Facade Cleaning Services in Chennai">
		...
		<nav class="navbar-inverse navbar-lg navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					<a href="http://kleanmax.com/cleaning/" class="navbar-brand brand"><img src="images/klean-logo.png" alt="logo"></a>
                </div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right navbar-login">
						<li>
							<a href="tel:<?= $obj->enquiry_mobile ?>"> <i class="fa fa-phone"></i> <?= $obj->contact_no ?></a>
						</li>
					</ul>
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Klean Max, No. 6, Jayam Industrial Estate, Chettyar Agaram 1st Street, Opp to Ishwarya Appartment, Vanagaram, Chennai - 600095..
...
Website refers to Klean Max, accessible from https://kleanmax.com/
...
By email: info@kleanmax.com

By phone number: 9710148218</p>
    		</div>
    	</div>
    </div>
	...
	<div class="footer-copy">
		<div class="container">
			&copy; 2020. Klean Max. All rights reserved. Designed by <a href="http://binaryresonance.com/">Binary Tech Resonance</a>
	    </div>
    </div>
</div>
