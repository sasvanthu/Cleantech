...
class Paginator
{
    ...
    public function __construct($params = array())
    {
        ...
        $this->urlPattern = $params['urlPattern'];
    ...
    public function toHtml()
    {
        ...
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li' . ($page['isCurrent'] ? ' class="page-item active"' : '') . '><a href="' . $page['url'] . '" class="page-link">' . $page['num'] . '</a></li>';
            } else {
                $html .= '<li class="page-item disabled"><span>' . $page['num'] . '</span></li>';
            }
        }
